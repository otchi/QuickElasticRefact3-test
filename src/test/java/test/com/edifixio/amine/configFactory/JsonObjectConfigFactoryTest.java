...
/**********************************************************************************************************************/
	...
	public static Collection<?> testValues(){
		...
		JsonObjectConfigFactory subObject=new JsonObjectConfigFactory(SimpleRootConfig.class, jsPrimitiveTypeConfig, childFactories);
...
/******************************************************************************************************************/
	...
	public void Test(){
		try {
		System.out.println(new JsonObjectConfigFactory(classToFactory, jsPrimitiveTypeConfig, childFactories)
