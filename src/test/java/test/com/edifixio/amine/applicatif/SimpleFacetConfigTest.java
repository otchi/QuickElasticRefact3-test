...
public class SimpleFacetConfigTest {
	...
	public static Collection<?> inputs() throws IOException{
		/*************** test 1 parameters ********/
		JsonObject jsonObject1=JsonHandleUtil.jsonFile(TestRessources.JSON_TEST_RESOURCE+"JsonToFacetsConfigTest1.json")
													.getAsJsonObject();
		 Map<String, FacetableAggr> facetsData1=Aggregations.getAggregations(jsonObject1.getAsJsonObject("_aggregation"))
		 ...
		 /*************** test 2 parameters ****************************************************************************/
		 	...
		 	JsonObject jsonObject2=JsonHandleUtil.jsonFile(TestRessources.JSON_TEST_RESOURCE+"JsonToFacetsConfigTest2.json")
												.getAsJsonObject();
			Map<String, FacetableAggr> facetsData2=Aggregations.getAggregations(jsonObject2.getAsJsonObject("_aggregation"))
						.getFacetableAggregations();
